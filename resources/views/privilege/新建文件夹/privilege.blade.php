...
<div class="page-content clearfix">
    ...
    <div class="search_style">
      ...
      {{-- <ul class="search_content clearfix">
       <li><label class="l_f">会员名称</label><input name="" type="text"  class="text_add" placeholder=""  style=" width:400px"/></li>
     ...
     <div class="border clearfix">
       <span class="l_f">
       <a href="{{ route('privilege_add') }}" id="member_add" class="btn btn-warning"><i class="icon-plus"></i>添加用户</a>
