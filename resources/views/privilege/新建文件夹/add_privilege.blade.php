...
<div class=" clearfix tj">
 ...
 <form action="" enctype="multipart/form-data" method="post">
        {{ csrf_field() }}
   <ul class="add_conent">
    <li class=" clearfix"><label class="label_name"><i>*</i>权限名称：</label>
         <input name="brand_name" type="text" class="add_text"/>
    </li>
    <li class=" clearfix"><label class="label_name"><i>*</i>对应的URL地址：</label>
        <input name="brand_name" type="text" class="add_text"/>
   </li>
    <li class=" clearfix"><label class="label_name"><i>*</i>所属地区：</label>
         <input name="region" type="text" class="add_text" style="width:120px"/>
    </li>
   </ul>
