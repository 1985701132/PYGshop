...
<div class="page-content clearfix">
  <div class="administrator">
    ...
    <div class="search_style">
      ...
      <ul class="search_content clearfix">
		  <form action="">
       <li><label class="l_f">管理员名称</label><input name="username" value="{{$req->username}}" type="text"  class="text_add" placeholder=""  style=" width:400px"/></li>
	...
	@foreach($admins as $v)
     <tr>
      ...
      <td class="td-manage">
		...
		<!-- <a title="编辑" onclick="member_edit('编辑','member-add.html','4','','510')" id="administrator_edit" href="javascript:;"  class="btn btn-xs btn-info" ><i class="fa fa-edit bigger-120"></i></a> -->
        <a title="编辑" id="administrator_edit" href="javascript:;"  class="btn btn-xs btn-info" ><i class="fa fa-edit bigger-120"></i></a>       		       
        <a title="删除" onclick="member_del(this,{{ $v->id }})" href="javascript:;" class="btn btn-xs btn-warning" ><i class="fa fa-trash  bigger-120"></i></a>
       </td>
	 </tr>
	 @endforeach
    </tbody>
	</table>
	{{ $admins->appends($req->except('page'))->links() }}
      </div>
	 </div>	 
  </div>
</div>
 ...
 <div id="add_administrator_style" class="add_menber" style="display:none">
    <form action="{{ route('admin.insert') }}" method="post" id="form-admin-add">
	{{ csrf_field() }}
 ...
 <!--修改管理员-->
 <div id="add_administrator_style2" class="add_menber" style="display:none">
...
$('#administrator_edit').on('click', function(){
	...
	area: ['700px',''],
	shadeClose: false,
	content: $('#add_administrator_style2'),
	});
